      ...
      <section class="top_banner_section">
        ...
        <section className={styles.event_cream}>
          <span className={styles.events_text}>
            ...
            <p className={styles.event_s_title}>
          ...
          <div className={styles.event_images}>
            <img
              src="\images\backgrounds\Events Page Panel Image 1.jpg"
              className={styles.event_img1}
              alt="pics from backend"
            ></img>

            <img
              src="\images\backgrounds\Events Page Panel Image 2.jpg"
              className={styles.event_img2}
              alt="pics from backend"
            ></img>

            <img
              src="\images\backgrounds\Events Page Panel Image 3.jpg"
