...
const FindUs = () => {
  return (
    <div className={styles.cream}>
      ...
      <p>
        The best place to find us is at our events, these are crazy days! Merch,
        cider, sun and fun, what more could we ask for? Besides who knows, maybe
        the P.I.G will make an appearance!
      </p>
      <h3>Events:</h3>
      <AllEvents />
      <h3>Not near you?</h3>
      <p>
        No stress, our full range is available throughout Sommerset. Here are
        some of our{" "}
        <a
